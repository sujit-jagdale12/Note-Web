	...
	<div class="container">
		...
		<p>
			<i>Note-taking (sometimes written as notetaking or note taking)
				...
				record of the event. Since the advent of writing and literacy, notes
				traditionally were almost always handwritten (often in notebooks),
				but the advent of notetaking software has made digital notetaking
				possible and widespread. Note-taking is a foundational skill in
				personal knowledge management.</i>
		</p>
		<img class="card-img-top m-10" style="max-width: 100px" alt="Photo"
			src="img/ph,jpg">
	</div>
